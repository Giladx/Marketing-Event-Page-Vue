    ...
    <div class="footer-max-width max-content-container">
      <div class="footer-banner">
        ...
        <div class="footer-btns-container">
          <button class="footer-register-now button-primary button-lg button">
            register NOW
          </button>
          <button
            class="footer-contact-us button button-outline button-lg-border"
          >
            CONTACT US
          </button>
        </div>
      ...
      <div class="footer-bottom-container">
        <div class="footer-left-side">
          ...
          <div class="footer-social-media">
            <span class="footer-text07">Follow market1</span>
      ...
      <div class="footer-copyright">
        <span class="footer-text23">
          <span>
            <span>
              © All rights reserved
              <span v-html="rawl2xq"></span>
            </span>
            <span><span v-html="rawxzhn"></span></span>
          </span>
          <a
          ...
          <span>
            <span>
              Powered by
              <span v-html="rawjie0"></span>
            </span>
            <span><span v-html="rawfgga"></span></span>
          </span>
          <a
          ...
          <span>
            <span>
              . Image source:
              <span v-html="raw81vj"></span>
            </span>
            <span><span v-html="raw929p"></span></span>
          </span>
          <a
