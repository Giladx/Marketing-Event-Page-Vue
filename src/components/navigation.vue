      ...
      <div data-type="MobileMenu" class="navigation-mobile-menu">
        <div class="navigation-nav1">
          <div class="navigation-container">
            ...
            <div data-type="CloseMobileMenu" class="navigation-close-mobile-menu">
          ...
          ></navigation-links>
          <button class="navigation-register1 button-primary button button-md">
            {{ button1 }}
          </button>
        </div>
        <div>
          <svg viewBox="0 0 950.8571428571428 1024" class="navigation-icon04">
            <path
            ...
            ></path></svg
          ><svg viewBox="0 0 877.7142857142857 1024" class="navigation-icon06">
            <path
            ...
            ></path></svg
          ><svg viewBox="0 0 602.2582857142856 1024" class="navigation-icon08">
            <path
...
export default {
  ...
  props: {
    ...
    image_src1: {
      type: String,
      default: '/playground_assets/logo-white-1500h.png',
    },
    image_alt: {
      type: String,
      default: 'logo',
...
.navigation-mobile-menu {
  ...
  background-image: url("/playground_assets/blue-background-1500h.png");
}
.navigation-nav1 {
  display: flex;
